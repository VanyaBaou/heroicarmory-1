...
public class WeaponPropertyCritBonus extends WeaponPropertyWithCallback {

    public WeaponPropertyCritBonus(float propMagnitude) {
        super("critbonus", HeroicArmory.MOD_ID, 1, propMagnitude);
    }
