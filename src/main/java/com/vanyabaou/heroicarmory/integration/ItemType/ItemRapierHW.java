...
public class ItemRapierHW extends ItemRapier implements IHeroicItem {

    protected int enchantability;
    protected int lootRarity;

    public ItemRapierHW(String unlocName, Object material, HashMap<String,Object> properties, WeaponProperty... weaponProperties) {
